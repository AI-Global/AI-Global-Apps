    ...
    return (
      <div class="title-box">
        <button 
          ...
          <p>
            <strong>
              Where in the World is AI? <HelpOutlineIcon style={{color: '#097AE8'}}/>
            </strong>
          </p>
        </button>
        <Modal
        ...
        >
          <p>Everyone is talking about AI, but <strong>how and where is it actually being used? </strong>
           ...
           <div style={{display: 'flex', alignItems:'center'}}><ErrorOutlineIcon style={{color: '#097AE8'}}/>&nbsp;<p style={{margin: "0", fontSize: '1.1em'}}><strong>Acknowledgment</strong></p></div>
